...
public class FleetTest {
    ...
    public static void setUpClass() {
        ...
        collection.deleteMany(Filters.exists("chassis"));
        collection.deleteMany(Filters.exists("types"));
        collection.insertOne(new Document("types", "Car"));
        collection.insertOne(new Document("types", "Truck"));
        collection.insertOne(new Document("types", "Bus"));
        mongoClient.close();
    }
    ...
    public void testInsertAndExists() {
        ...
        Fleet.getInstance().delete(veichle);
        System.out.println("\t\tOK");
    }
    ...
    public void testListAll() {
        ...
        for (Veichle v : result) {
            System.out.println("VEICHLE" + v.toString());
        }
